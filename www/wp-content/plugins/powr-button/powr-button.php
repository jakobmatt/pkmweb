<?php
    ...
    */
    ...
    function powr_button_options() {
      ...
      echo '<iframe id="powr-button" src="https://www.powr.io/wp-create/button" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
